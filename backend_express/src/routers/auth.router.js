...
import { login_controller, register_controller, resend_email_controller, verify_email_controller } from '../controllers/auth.controller.js'
...
router.post('/resend-email',resend_email_controller)
